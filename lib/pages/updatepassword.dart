...
class _UpdatepasswordWidgetState extends State<UpdatepasswordWidget> {
  ...
  void initState() {
    ...
    _model.newpassword2Controller ??= TextEditingController();
          ...
          children: [
            Padding(
              ...
              child: TextFormField(
                ...
                validator:
                    _model.oldpasswordControllerValidator.asValidator(context),
              ),
            ),
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20, 0, 20, 16),
            ...
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20, 0, 20, 16),
              child: TextFormField(
                controller: _model.newpassword2Controller,
                ...
                style: FlutterFlowTheme.of(context).bodyMedium,
                validator:
                    _model.newpassword2ControllerValidator.asValidator(context),
              ),
            ),
            Align(
